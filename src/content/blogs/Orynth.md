...
実は現在、**Orynthを利用しているユーザーの多くは日本人です。**
...
「オープンソースは儲からないという常識は過去のものになった」
コードは無料で公開しつつ、コミュニティからの支援で公開わずか3日間で約6000ドル（約90万円）の資金を獲得した事例です。

https://x.com/Sikino_Sito/status/2009065718533521826?s=20

**(2) Onigiri Anki（AI語学学習）**
AIを活用した日本語学習ツールです。「Web3 × 個人開発」の可能性を示し、1日で7800ドル（約120万円）もの収益を上げるなど、グローバルなユーザーにリーチしています。

https://x.com/statistics1012/status/2009409883582746960?s=20

**(3) Tinies Merge（2048 × オートバトラーゲーム）**
手前味噌になりますが、私が開発したゲーム「Tinies Merge」もOrynthでローンチしました。
パズルと戦略バトルを組み合わせたゲームで、公開直後から海外ユーザーに遊んでもらっています。単なる資金調達だけでなく、こうしたゲームのテストマーケティングの場としても機能しています。

https://x.com/tty215_dev/status/2009321679395409973?s=20

## なぜOrynthが「革新的」と言われるのか？

「資金調達」や「トークン発行」自体は新しいものではありません。しかし、Orynthがこれほど注目を集めている理由は、実際に使ってみると、既存のWeb3サービスが抱えていた「怪しさ」や「使いにくさ」を解消し、以下の3つの価値を開発者に提供してくれている点にあると感じます。
